...
/***/ "./src/aula107_projeto/form-control.ts":
/*!*********************************************!*\
  !*** ./src/aula107_projeto/form-control.ts ***!
  \*********************************************/
...
function checkForEmptyFields(...inputs) {
    inputs.forEach((input) => {
        if (!input.value)
            showErrorMessage(input, 'Este campo nao pode ser vazio');
    });
}
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__webpack_require__(/*! ./form-control */ "./src/aula107_projeto/form-control.ts");
console.log('oi');
